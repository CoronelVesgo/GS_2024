...
function inicializarVeiculos(veiculos) {
    ...
    // Atualiza os status a cada 1 segundo1
    setInterval(() => updateVehicleCharge(vehicleElements), 1000);
}
